...
from egl_renderer.utils.geometry import perspective
from egl_renderer.utils.shaders import (
    VERTEX_SHADER_DEPTH, FRAGMENT_SHADER_DEPTH,
    SCREEN_VERTEX_SHADER, EQUIRECT_FRAGMENT_SHADER
)
...
def render_360(width, height, framerate, data_file, camera_file, video_file,
    ...
    Output: 2:1 video with spherical-video metadata for headset auto-detection.
    """
    ...
    for i, frame in enumerate(tqdm(cam_path, desc="Rendering VR360", unit="frames")):
        pos = frame[:3]
        ...
        # ── Pass 2: project cubemap → equirectangular ──────────────────────────
